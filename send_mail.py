...
def prepare_and_send_email(recipient, subject, message_text, attachment):
    ...
    try:
        ...
        # create message
        message = create_message('csaifw21003@glbitm.ac.in', recipient, subject, message_text, attachment)
...
if __name__ == "__main__":
    ...
    prepare_and_send_email('sinhsaurabh079@gmail.com', 'Task || Nvidia Training', 'Email with PDF attachment', 'photo.jpeg')
